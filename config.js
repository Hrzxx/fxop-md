...
module.exports = {
   ...
   // String Values
   SESSION_ID: process.env.SESSION_ID || "Session~Sp2X9X82",
   HANDLERS: process.env.HANDLER === "false" || process.env.HANDLER === "null" ? "^" : "[.]",
   BOT_INFO: process.env.BOT_INFO || "ᴀsᴛʀᴏ;ғxᴏᴘ-ᴍᴅ", // junaid;avishna♤;https://f.uguu.se/HRUHGMlL.mp4'
   SUDO: process.env.SUDO || "917305378115",
